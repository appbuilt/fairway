          ...
          : React.createElement(React.Fragment, null,
              React.createElement("button", {
                ...
                React.createElement("svg", { viewBox: "0 0 24 24", width: 18, height: 18, fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" },
                  ...
                  React.createElement("polyline", { points: "15 3 12 0 9 3" }),
                  React.createElement("line", { x1: "12", y1: "0", x2: "12", y2: "13" })
                ),
                "Share…"
              ),
              React.createElement("button", {
              ...
              status === "error" && React.createElement("div", { style: { textAlign: "center", fontSize: 13, color: "var(--red)", marginTop: 4 } }, "Something went wrong. Please try again.")
            )
      )
    )
  );
